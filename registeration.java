...
import java.io.*;
import java.lang.*;
class booking extends Thread //thread class
{	public void run()	
	{
		try
		{
			if(payment1.opt ==1 ||payment1.opt ==2)
			{	
...
class doctor extends dental //inheritance
{	
...
class registeration
{
	...
	static void fee() //static method
	{
 	...
 	registeration(String fname,String lname,String phno,String eml,String pwd,String address)//constructor
	{
		this.fname=fname;
		this.lname=lname;
		this.phno=phno;
	...
	{	
		...
		registeration br= new registeration(fname,lname,phno,eml,pwd,address);
